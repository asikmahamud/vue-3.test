...
function addToCart(){
  store.addCart({...props.product, quantity: 1})
}
</script>
...
<template>
    <div class="bg-cyan-700 rounded-lg overflow-hidden">
      ...
      <div class="p-4">
        ...
        <button v-else @click="addToCart()" class="flex items-center justify-center font-semibold w-full text-center bg-cyan-500 text-white rounded py-1 hover:bg-cyan-600 transition active:scale-90">
          Add to Cart
        </button>
      </div>
    </div>
